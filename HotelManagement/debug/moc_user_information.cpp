...
**
** Created: Sun May 17 17:26:22 2015
...
static const char qt_meta_stringdata_user_information[] = {
    "user_information\0\0on_pushButton_clicked()\0"
...
const QMetaObjectExtraData user_information::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject user_information::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_user_information,
      qt_meta_data_user_information, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &user_information::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_user_information))
